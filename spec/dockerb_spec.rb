...
describe Dockerb do
  ...
  describe ".compile" do
    ...
    it "generates a Dockerfile" do
      ...
      Dockerb.compile { File.read("Dockerfile") }.should == "# Generated by dockerb, do not modify\nXXX\n# Generated by dockerb, do not modify\n"
    end
  ...
  describe Dockerb::Context do
    describe ".compile" do
      def call(*args)
        Dockerb::Context.send(:compile, *args).gsub(/\s*# Generated by dockerb, do not modify\s*/m, "")
      end
  ...
  describe "CLI" do
    ...
    it "generates a Dockerfile" do
      ...
      dockerb("")
      File.read("Dockerfile").should == "# Generated by dockerb, do not modify\n3\n# Generated by dockerb, do not modify\n"
    end
