...
describe Dockerb do
  ...
  describe ".compile" do
    ...
    it "generates a non-standard file" do
      File.write("DockerfileProduction.erb", "XXX")
      File.write("DockerfileProduction", "YYY")
      Dockerb.compile("DockerfileProduction") { File.read("DockerfileProduction") }.should include "XXX"
    end
